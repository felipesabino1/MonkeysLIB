/*
    ...
    Na funcao que faz o lagrange mesmo, alterar os parametros da funcao g de acordo com o que faz
*/
struct Lagrange{
    vector<ll> pref,suf;
    vector<ll> invfat;
    ...
    ll x,n;
    ll mod;
    // geralmente o negocio da funcao de dentro precisa de mais informacao
    ll pte;
    ...
    // o solve, calcula o valor do polinomio no ponto x, com grau n (lg - lagrange)
    ll lg(){
        if(x <= n+1){
            ll ans=0;
